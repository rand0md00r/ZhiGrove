import{_ as i,c as s,o,j as e,a as n}from"./chunks/framework.OaOo95RB.js";const h=JSON.parse('{"title":"-- coding: utf-8 --","description":"","frontmatter":{},"headers":[],"relativePath":"00-inbox/week-37/250909-0023-dino语义监督.md","filePath":"00-inbox/week-37/250909-0023-dino语义监督.md"}'),r={name:"00-inbox/week-37/250909-0023-dino语义监督.md"};function a(d,t,l,f,p,_){return o(),s("div",null,[...t[0]||(t[0]=[e("h1",{id:"coding-utf-8",tabindex:"-1"},[n("-"),e("em",null,"- coding: utf-8 -"),n("- "),e("a",{class:"header-anchor",href:"#coding-utf-8","aria-label":'Permalink to "-*- coding: utf-8 -*-"'},"​")],-1),e("h1",{id:"src-models-dino-dinov2-backbone-py",tabindex:"-1"},[n("src/models/dino/dinov2_backbone.py "),e("a",{class:"header-anchor",href:"#src-models-dino-dinov2-backbone-py","aria-label":'Permalink to "src/models/dino/dinov2_backbone.py"'},"​")],-1),e("p",null,"import os import sys import glob import torch import torch.nn as nn import torch.nn.functional as F",-1),e("p",{"global:":"","(B,D),":"","patch:":"","(B,N,D":"",或:"","None)":""},'class DINOv2Backbone(nn.Module): """ 离线版 DINOv2 封装（不使用 torch.hub）： - 从官方源码构建骨干（需要提供 dinov2 源码根目录） - 从本地权重文件夹自动加载权重（支持 model.safetensors / pytorch_model.bin / *.pth） - forward(x) 返回',-1),e("pre",null,[e("code",null,`参数：
...
def forward(self, x: torch.Tensor):
    ...
    return out
`)],-1),e("h1",{id:"dino-v2-离线",tabindex:"-1"},[n("=== Dino v2（离线） === "),e("a",{class:"header-anchor",href:"#dino-v2-离线","aria-label":'Permalink to "=== Dino v2（离线） ==="'},"​")],-1),e("p",null,`dino_v2 = dict( type=DINOv2Backbone, variant='vitl14', repo_dir="/vepfs/group03/wyq/ug_uni/dinov2-main", # 官方源码根目录（含 dinov2/） weights_dir="/vepfs/public/model-public/dinov2-large", # 你的本地模型文件夹 # 如果你想指定具体文件，也可加： # weights_path="/vepfs/public/model-public/dinov2-large/model.safetensors", )`,-1)])])}const m=i(r,[["render",a]]);export{h as __pageData,m as default};
